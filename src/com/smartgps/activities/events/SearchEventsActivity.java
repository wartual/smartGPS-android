...
import com.smartgps.activities.places.PlacesActivity;
...
public class SearchEventsActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setActionbarTitle(getString(R.string.search_events));
		initArrays();
		initUI();
	}
	...
	private void startSearchForEvents() {
		Intent intent = new Intent(SearchEventsActivity.this,
		...
		intent.putExtra(EventsActivity.EVENT, model);
		intent.putExtra(EventsActivity.LOCATION, lastLocation);
	...
	private void getDestinations() {
		if (address.getVisibility() == View.VISIBLE) {
			list = Utilities.getDestinationsFromAddress(
					SearchEventsActivity.this, address.getText().toString());
	...
	public void onConnected(Bundle arg0) {
		...
		SmartDestinationModel model = Utilities
				.getDestinationFromGpsCoordinates(SearchEventsActivity.this,
